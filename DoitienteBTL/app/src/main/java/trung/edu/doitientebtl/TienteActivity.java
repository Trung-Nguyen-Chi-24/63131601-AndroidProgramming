    ...
    private void setRateAndToolbar(String country) {
        ...
        switch (country) {
            case "US":
                ...
                toolbar.setNavigationIcon(R.drawable.ic_us);
                break;
            case "China":
                rate = 0.00031;
                toolbar.setTitle("Chuyển đổi VND - NDT");
                toolbar.setNavigationIcon(R.drawable.ic_china);
                break;
            case "Korea":
                rate = 0.054;
                toolbar.setTitle("Chuyển đổi VND - KRW");
                toolbar.setNavigationIcon(R.drawable.ic_korean);
                break;
            case "UK":
                rate = 0.000033;
                toolbar.setTitle("Chuyển đổi VND - GBP");
                toolbar.setNavigationIcon(R.drawable.ic_uk);
                break;
        }
    }
